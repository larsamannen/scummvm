...
static const DebugChannelDef debugFlagList[] = {
	{Deskadv::kDebugResource, "Resource", "Resource Debug Flag"},
	{Deskadv::kDebugSaveLoad, "Saveload", "Saveload Debug Flag"},
	{Deskadv::kDebugScript, "Script", "Script Debug Flag"},
	{Deskadv::kDebugText, "Text", "Text Debug Flag"},
	{Deskadv::kDebugCollision, "Collision", "Collision Debug Flag"},
	{Deskadv::kDebugGraphics, "Graphics", "Graphics Debug Flag"},
	{Deskadv::kDebugSound, "Sound", "Sound Debug Flag"},
	DEBUG_CHANNEL_END
};
...
class DeskadvMetaEngineDetection : public AdvancedMetaEngineDetection {
public:
	DeskadvMetaEngineDetection() : AdvancedMetaEngineDetection(gameDescriptions, sizeof(DeskadvGameDescription), deskadvGames) {
	}
...
public:
	...
	Common::Error createInstance(OSystem *syst, Engine **engine, const ADGameDescription *desc) const;
	bool hasFeature(MetaEngineFeature f) const;
};

Common::Error DeskadvMetaEngine::createInstance(OSystem *syst, Engine **engine, const ADGameDescription *desc) const {
...
REGISTER_PLUGIN_STATIC(DESKADV_DETECTION, PLUGIN_TYPE_ENGINE_DETECTION, DeskadvMetaEngineDetection);
