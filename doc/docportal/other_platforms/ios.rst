...
.. code::
    ...
    ../scummvm/devtools/create_project/xcode/build/Release/create_project ../scummvm --xcode --use-xcframework --enable-faad --enable-fluidsynth --enable-gif --enable-mpeg2 --disable-nasm --disable-taskbar --disable-tts
