...
Copy the contents of the ``scummvm-ios7-libs-v3`` folder you extracted earlier into the ``build`` directory, using either the Finder, or the command line as follows:

.. code-block::

    cp -r ~/Downloads/scummvm-ios7-libs-v3/* ~/build/
...
.. code::
    ...
    ../scummvm/devtools/create_project/xcode/build/Release/create_project ../scummvm --xcode --enable-faad --enable-fluidsynth --enable-gif --enable-vpx --disable-nasm --disable-opengl --disable-taskbar --disable-tts
